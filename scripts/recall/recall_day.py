...
Shared functions (importable) + CLI entry point.

Usage:
    uv run python scripts/recall/recall_day.py list DATE_EXPR [--min-msgs N] [--all-projects]
    uv run python scripts/recall/recall_day.py expand SESSION_ID
