...
The following files provide critical instructions and context for this environment. You must respect the directives in these files:

- **CLAUDE.md**: Contains project-specific instructions, commands, and preferences.
- **AGENTS.md**: Contains guidance for AI assistants, including the "Respect User Time" protocol, sub-agent optimization strategy, and available specialized agents.
