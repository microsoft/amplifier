...
**Frontend reference docs** (consult when making visual/UX decisions):
- `ai_context/design/UX-REVIEW-CHECKLIST.md` — Prioritized UX checklist (accessibility, layout, typography, color)
- `ai_context/design/COLOR-STRATEGY.md` — Semantic color tokens, dark mode elevation, accessible pairs
