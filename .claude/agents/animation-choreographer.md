...
**Frontend reference docs** (consult for animation-related UX rules):
- `ai_context/design/UX-REVIEW-CHECKLIST.md` — Priority 7: Animation rules (durations, easing, interruptibility, reduced-motion)
