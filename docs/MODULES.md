...
| **computer-use** | Gives an LLM control of a real desktop — Windows (via WSL2), macOS, or Linux/X11 — using each provider’s own native computer-use tool. Runs locally or drives a remote machine over SSH with no agent installed on the target. | [amplifier-bundle-computer-use](https://github.com/microsoft/amplifier-bundle-computer-use) |
