...
def mock_codex_session_dir(temp_dir):
    ...
    history = [
        {"session_id": session_id, "ts": 1640995200, "text": "Test message"}
    ]
...
class TestQualityCheckWorkflows:
    ...
    def test_quality_check_after_code_edit_claude(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
    ...
    def test_quality_check_after_code_edit_codex(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
        ...
        with patch('subprocess.run', return_value=mock_make_check_success):
            ...
            try:
                ...
                result = check_code_quality(
                    file_paths=["main.py"],
                    tool_name="Write",
                    cwd=str(integration_test_project)
                )
    ...
    def test_quality_check_finds_project_root(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
    ...
    def test_quality_check_with_multiple_files(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
...
class TestWorktreeQualityChecks:
    ...
    def test_quality_check_in_worktree(self, integration_test_project, mock_make_check_success, mock_subprocess_run, monkeypatch):
    ...
    def test_quality_check_worktree_venv_detection(self, integration_test_project, mock_make_check_success, mock_subprocess_run, monkeypatch):
...
class TestCrossBackendQualityChecks:
    ...
    def test_quality_checks_produce_same_results(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
    ...
    def test_quality_checks_share_makefile(self, integration_test_project, mock_make_check_success, mock_subprocess_run):
        ...
        make_calls = [call for call in mock_subprocess_run.call_args_list 
                     if "make" in str(call[0]) and "check" in str(call[0])]
