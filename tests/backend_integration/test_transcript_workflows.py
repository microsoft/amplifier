...
from amplifier.core.backend import ClaudeCodeBackend, CodexBackend, BackendOperationError
    ...
    def test_bidirectional_conversion_preserves_content(self, integration_test_project, mock_claude_transcript):
        ...
        try:
            ...
            with patch.object(manager, 'convert_format') as mock_convert:
                ...
                # Claude -> Codex
                success1 = manager.convert_format(
                    session_id="test_session",
                    from_backend="claude",
                    to_backend="codex"
                )
                ...
                # Codex -> Claude (back)
                success2 = manager.convert_format(
                    session_id="test_session",
                    from_backend="codex",
                    to_backend="claude"
                )
...
class TestTranscriptManagerIntegration:
    ...
    def test_transcript_manager_lists_both_backends(self, integration_test_project, mock_claude_transcript, mock_codex_session_dir):
    ...
    def test_transcript_manager_search_across_backends(self, integration_test_project, mock_claude_transcript, mock_codex_session_dir):
    ...
    def test_transcript_manager_restore_combined_lineage(self, integration_test_project, mock_claude_transcript, mock_codex_session_dir):
        ...
        try:
            ...
            with patch.object(manager, 'list_transcripts') as mock_list:
                mock_list.return_value = [
                    exported_dir / "transcript.md",
                    mock_codex_session_dir / "transcript.md"
                ]
