...
def mock_claude_sdk():
    ...
    with patch('amplifier.core.agent_backend.ClaudeSDKClient') as mock_sdk_class, \
...
def mock_both_backends_available():
    ...
    with patch('amplifier.core.agent_backend.ClaudeCodeAgentBackend.is_available', return_value=True), \
...
class TestClaudeAgentWorkflows:
    ...
    def test_claude_spawn_multiple_agents_sequentially(self, integration_test_project, mock_claude_sdk, create_test_agents):
...
class TestCodexAgentWorkflows:
    ...
    def test_codex_spawn_with_custom_profile(self, integration_test_project, mock_codex_exec_success, create_test_agents, codex_env):
...
class TestConvenienceFunctions:
    ...
    def test_spawn_agent_convenience_function_claude(self, integration_test_project, mock_claude_sdk, create_test_agents, claude_env):
    ...
    def test_spawn_agent_convenience_function_codex(self, integration_test_project, mock_codex_exec_success, create_test_agents, codex_env):
    ...
    def test_spawn_agent_auto_backend_selection(self, integration_test_project, mock_both_backends_available, create_test_agents, claude_env):
